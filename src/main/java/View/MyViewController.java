...
public class MyViewController extends AView implements Observer {
    ...
    Media mazeSong = new Media(getClass().getResource("../music/maze1.mp3").toExternalForm());
    ...
    public void setChosenChar(String chosenChar) {
        ...
        String filePath = "./resources/images/characters_goals/"+chosenChar+".jpg";
    ...
    public void zoom(ScrollEvent scrollEvent) {
        //event handler for zoom events, this event check if the maze exists and if ctrl is pressed
    ...
    public void dragCharacter(MouseEvent e){
        //if maze is not null, compute the movement of the mouse and determine of the drag shoud move the player to another cell
        if(maze==null)
            return;
        if(!dragOnPlayer)
            return;
